...
import { fetchAlertasLicencas, fetchAlertasOutorgas, fetchOutorgas, fetchLicencas, fetchClientes } from '../lib/api'
...
export default function Relatorios() {
    ...
    const toRelatorioItem = (lic: Licenca): RelatorioItem => ({
        ...
        cnpj: lic.cnpj,
        cidade: lic.cidade || clientes.find(cl => cl.cnpj && lic.cnpj && cl.cnpj === lic.cnpj)?.cidade || null,
    ...
    const toRelatorioItemOut = (out: Outorga): RelatorioItem => ({
        ...
        cnpj: out.cnpj,
        cidade: todasLicencas.find(l => l.cnpj && out.cnpj && l.cnpj === out.cnpj)?.cidade || clientes.find(cl => cl.cnpj && out.cnpj && cl.cnpj === out.cnpj)?.cidade || null,
