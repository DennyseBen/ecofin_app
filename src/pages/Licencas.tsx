...
export default function Licencas() {
    ...
    const filteredLicencas = useMemo(() => {
        return licencas.filter(c => {
            ...
            // Se licença não tem cidade própria, busca no cadastro do cliente pelo CNPJ
            const cidadeLicenca = c.cidade || clientes.find(cl => cl.cnpj && c.cnpj && cl.cnpj === c.cnpj)?.cidade || ''
            const matchSearch = String(c.razao_social || '').toLowerCase().includes(s) ||
                ...
                cidadeLicenca.toLowerCase().includes(s) ||
    ...
    }, [licencas, clientes, search, filterType, filterStatus, filterRenovar, filterDias, dateFrom, dateTo, filterRiaa])
